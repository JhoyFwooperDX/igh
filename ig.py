...
# USN=Mozilla/5.0 (Linux; Android 11; RMX3231) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.210 Mobile Safari/537.36
#ugen=open('ua.txt','r').read().splitlines()
ugen = random.choice(["Mozilla/5.0 (iPhone; CPU iPhone OS 15_0_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Instagram 213.1.0.22.117 (iPhone13,2; iOS 15_0_2; en_US; en-US; scale=3.00; 1170x2532; 332048479)"])
...
def banner():
    clear()
    lo = f'{P2}[{H2}+{P2}] Author       : {H2}HOER.XD\n{P2}[{H2}+{P2}] Instagram    : {H2}HOER.XD\n{P2}[{H2}+{P2}] Version      : {H2}2.0'
